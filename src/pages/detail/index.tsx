  ...
  return (
    <Fragment>
      {getProductsLoading ? (
        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white h-[calc(100svh-4.5rem)] overflow-y-auto scroll-bar-custom">
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5 justify-between">
                  ...
                  <div className="flex ml-6 items-center text-red-400">
                ...
                <section className="mb-2 border-t-2 border-gray-200">
                  <h2 className="text-gray-900 text-xl title-font font-medium mb-2 pt-2">
                    Reviews
                  </h2>
